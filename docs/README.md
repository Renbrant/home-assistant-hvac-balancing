# HVAC Balancing Documentation

**Current Production release: v0.2.0-beta.9**

| Document | Purpose |
|---|---|
| [Installation](INSTALLATION.md) | Install and configure v0.2 |
| [Production Monitoring](MONITORING.md) | Monitor controller and actuators |
| [Production Cutover](v0.2-production-cutover.md) | Migration and safety process |
| [Controller Parity](v0.2-controller-parity-spec.md) | v0.1.3 behavioral compatibility |
